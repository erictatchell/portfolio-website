...
export default function Menu() {
    ...
    return (
        <div className="grid sm:grid-cols-1 sm:grid-rows-1 gap-4 items-center">
            ...
            <button onClick={() => setHash('bio')} className={`col-start-1 inline-flex justify-center items-center px-3 py-2 text-xl font-medium text-center border-2 border-black rounded-none focus:outline-none focus:ring-0 ${currentHash === '#bio' ? 'bg-black text-white hover:bg-black' : 'hover:bg-black text-black hover:text-white'}`}>
