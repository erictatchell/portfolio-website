...
export default function Tabs() {
    ...
    return (
        <div className='grid'>
            <button onClick={() => setHash('bio')} className={`col-start-1 inline-flex justify-center border-b items-center px-8 py-2 text-xl font-medium text-center border-2 border-black rounded-none focus:outline-none focus:ring-0 ${currentHash === '#bio' ? 'bg-[#B3004C] text-white hover:bg-[#B3004C]' : 'hover:bg-[#B3004C] hover:bg-opacity-20 hover:backdrop-blur-[1.5px] text-black hover:text-white'}`}>
